...
class Optimizer(object):
    ...
    def tell(self, self1, x, y, fit=True):
        ...
        return self._tell(self1, x, y, fit=fit)

    def _tell(self, self1, x, y, fit=True):
        ...
        if (fit and self._n_initial_points <= 0 and
            ...
            with warnings.catch_warnings():
                ...
                self1.mode_fit_time = time.process_time() - start
